    ...
    <div className="mx-auto flex w-full max-w-sm flex-1 flex-col justify-center px-4 py-16">
      ...
      <div className="flex flex-col gap-3">
        <button
          ...
          className="flex h-11 w-full items-center justify-center gap-3 rounded-md border border-zinc-300 bg-white font-medium text-zinc-700 transition-colors hover:bg-zinc-50"
        >
          <GoogleIcon />
        ...
        <button
          ...
          className="flex h-11 w-full items-center justify-center gap-3 rounded-md border border-zinc-300 bg-zinc-900 font-medium text-white transition-colors hover:bg-zinc-700"
        >
          <GitHubIcon />
